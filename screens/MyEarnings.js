    ...
    render() {
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ width: '100%', height: height - 600 }}>
                ...
                <View style={{ marginTop: 70 }}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', marginLeft: 20, letterSpacing: 1.5, }}>Total Earned: $</Text>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', marginLeft: 20, letterSpacing: 1.5 }}>Current Balance: $</Text>
                </View>
